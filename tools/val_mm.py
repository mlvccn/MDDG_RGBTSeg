...
def main(cfg):
    ...
    for case in cases:
        ...
        model = eval(cfg['MODEL']['NAME'])(cfg['MODEL']['BACKBONE'], dataset.n_classes, cfg['DATASET']['MODALS'],loss_cfg['AUX_LOSS'])
        ...
        loss_fn = get_loss('OhemCrossEntropy',255, None)
        print(loss_fn)
        if True:
            if eval_cfg['MSF']['ENABLE']:
                ...
                acc, macc, f1, mf1, ious, miou, _ = evaluate(model, dataloader, device, loss_fn)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='configs/fmb_rgbt.yaml')
